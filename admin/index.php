...
if($_POST) 
{
	...
	$q = "SELECT * FROM users_admin WHERE staffno = '$staffno' AND password = '$password'";
...
<div id="logo-strip">
	<div id="left-space"> 
    	<i class="fa fa-unlock" style="font-size:12px;color:black; float:left; margin-right: 5px; margin-top: 25px;"></i><h1 style="float:left;">Admin Login</h1>
    </div>
    <div id="right-space"> 
...
<form action="index.php" method="POST" id="frmlogin" name="frmlogin">
	...
	<div class="login-line">
        ...
        <input class="login-input" type="text" id="staffno" name="staffno" placeholder="Enter your admin number" required/>
    </div>
